  ...
  return (
    <>
      <div>
        ...
        <div className="rate">
          {/* <div className="rate-title">지원현황</div> */}
          <table className="rate-list">
            ...
            <tr>
              ...
              <td rowSpan={2}>{commonData && commonData.rate}</td>
            </tr>
            <tr>
              <td>타지역</td>
            ...
            <tr>
              ...
              <td rowSpan={2}>{oneParentData && `${oneParentData.rate}`}</td>
            </tr>
            <tr>
              <td>타지역</td>
            ...
            <tr>
              ...
              <td rowSpan={2}>{meisterData && `${meisterData.rate}`}</td>
            </tr>
            <tr>
              <td>타지역</td>
            ...
            <tr>
              ...
              <td rowSpan={2}>{cityFirstData && `${cityFirstData.rate}`}</td>
            </tr>
            <tr>
              <td>타지역</td>
            ...
            <tr>
              ...
              <td rowSpan={2}>{foreignData && `${foreignData.rate}`}</td>
            </tr>
            <tr>
              <td>타지역</td>
