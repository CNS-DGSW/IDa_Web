...
const WritePhoto = ({ handleImageChange, preview, onSave, isChanged }: WritePhotoProps) => {
  return (
    <>
      <WriteContent title="지원자의 사진을 등록해 주세요" onSave={onSave} isChanged={isChanged}>
        <div className="photo">
          {preview ? (
          ...
          <input type="file" id="preview" onChange={handleImageChange} accept=".jpg, .jpeg, .gif, .png" />
