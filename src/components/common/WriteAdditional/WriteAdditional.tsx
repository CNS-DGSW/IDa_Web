        ...
        <div className="addition-body">
          ...
          <div>
            <input
              type="number"
              value={volunteer1}
              onChange={(e) => handleVolunteer1(e.target.valueAsNumber)}
            />
          </div>
          <div>
            <input
              type="number"
              value={volunteer2}
              onChange={(e) => handleVolunteer2(e.target.valueAsNumber)}
            />
          </div>
          <div>
            <input
              type="number"
              value={volunteer3}
              onChange={(e) => handleVolunteer3(e.target.valueAsNumber)}
            />
          </div>
        </div>
      </div>
        ...
        <div className="leader-content">
            ...
            <div className="leader-content-head-check">
              <div className="leader-content-head-check-box">
                <input
                  ...
                  onChange={(e) => handleLeadership11(e.target.checked)}
                />
              </div>
              <div className="leader-content-head-check-box">
                <input
                  ...
                  onChange={(e) => handleLeadership12(e.target.checked)}
                />
              </div>
            </div>
            ...
            <div className="leader-content-head-check">
              <div className="leader-content-head-check-box">
                <input
                  ...
                  onChange={(e) => handleLeadership21(e.target.checked)}
                />
              </div>
              <div className="leader-content-head-check-box">
                <input
                  ...
                  onChange={(e) => handleLeadership22(e.target.checked)}
                />
              </div>
            </div>
            <div className="leader-content-head-check">
              <div className="leader-content-head-check-box">
                <input
                  ...
                  onChange={(e) => handleLeadership31(e.target.checked)}
                />
              </div>
              <div className="leader-content-head-check-box">
                <input
                  ...
                  onChange={(e) => handleLeadership32(e.target.checked)}
                />
              </div>
            </div>
          </div>
          <div className="leader-content-select">
            <input
              type="number"
              value={prize}
              onChange={(e) => handlePrize(e.target.valueAsNumber)}
            />
          </div>
        </div>
      </div>
