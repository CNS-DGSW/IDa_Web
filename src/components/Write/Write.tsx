...
const Write = ({ page, pageHandle }: WriteProps) => {
  ...
  let nowPage = useMemo(() => {
    ...
    if (page === 0) nowPage = <WriteStudent />;
    else if (page === 1) nowPage = <WriteParent />;
    else if (page === 2) nowPage = <WritePhoto />;
    else if (page === 3) nowPage = <WriteSchool />;
    else if (page === 4) nowPage = <WriteAdmission />;
    else if (page === 5) nowPage = <WriteGrades />;
    else if (page === 6) nowPage = <WriteIntroduction />;
